function [C,Aout,ff,f,P,S,YrA] = drg_update_temporal_components_fast(Y,A,b,Cin,fin,P,options)
...
%Diego added this for some components of A that have zero values
Aout=A;