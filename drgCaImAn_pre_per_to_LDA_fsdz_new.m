function handles_out2=drgCaImAn_pre_per_to_LDA_fsdz_new(pre_perBatchPathName, pre_perFileName, p_threshold, MLalgo, show_figures,no_sp_sm_trials_to_use,first_sp_sm_trial_no)
%
...
close all
clearvars -except pre_perBatchPathName pre_perFileName p_threshold MLalgo show_figures no_sp_sm_trials_to_use first_sp_sm_trial_no
warning('off')
