function [adc_in,digital_input,acq_rate,amplifier_data_out]=drg_read_Intan_RHD2000_file(filename,adc_channels_out)
...
if ~isempty(amplifier_data)
    amplifier_data_out(:,:)=amplifier_data(9:24,:);
end
 
fprintf(1, 'Done reading rhd...\n');
