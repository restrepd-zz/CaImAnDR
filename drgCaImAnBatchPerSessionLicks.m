function drgCaImAnBatchPerSessionLicks(choiceBatchPathName,choiceFileName)
...
lick_threshold=50; %This is the threshold to exclude the runs where Ming was adding water manually, this was set at 20
t_odor_on=0;
t_odor_off=4;
