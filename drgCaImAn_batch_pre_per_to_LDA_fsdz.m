    ...
    for fileNo=1:length(handles.FileName_pre_per)
        ...
        for p_threshold=handles.p_thresholds
            for MLalgo=handles.MLalgo
                ...
                handles_out.ii_out(ii_out).handles=drgCaImAn_pre_per_to_LDA_fsdz_new(pre_per_PathName, pre_per_FileName,p_threshold,MLalgo,handles.show_figures,handles.no_sp_sm_trials_to_use, handles.first_sp_sm_trial_no);
